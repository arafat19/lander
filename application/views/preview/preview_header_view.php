...
<head>
    ...
    <title>Theme <?php echo $lander_theme_parameters['lander_theme_name']; ?> - SDIL Lander</title>
    <link href="<?php echo base_url();?>css/lander_vegas.css" rel="stylesheet">
    <?php if ($lander_theme_parameters['lander_theme_add_bootstrap']) { ?>
        <link href="<?php echo base_url(); ?>css/bootstrap.min.css" rel="stylesheet">
    <?php } ?>
    <style type="text/css">
       <?php //eval("\$lander_theme_css = \"$lander_theme_css\";"); echo $lander_theme_css ;
       eval('?>'.$lander_theme_parameters['lander_theme_css'].'<?'); ?>
    </style>
